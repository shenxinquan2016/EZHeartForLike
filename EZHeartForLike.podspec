Pod::Spec.new do |s|
  ...
  s.author             = { "EzfenCheung" => "ezfen_zhang@163.com" }
  # Or just: s.author    = "EzfenCheung"
  # s.authors            = { "EzfenCheung" => "ezfen_zhang@163.com" }
  # s.social_media_url   = "http://twitter.com/EzfenCheung"
  ...
  s.source       = { :git => "https://github.com/Ezfen/EZHeartForLike.git", :tag => s.version.to_s }
